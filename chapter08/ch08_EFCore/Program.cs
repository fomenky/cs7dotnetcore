        ...
        static void Main(string[] args)
        {
            using(var db = new Northwind())
            {
                ...
                using(IDbContextTransaction t = db.Database.BeginTransaction())
                {
                    ...
                    // IQueryable<Category> cats = db.Categories.Include(c => c.Products); // Eager/Early Loading
                    // IQueryable<Category> cats = db.Categories; // Lazy Loading
                    
                    IQueryable<Category> cats; // Explicit Loading entities
                    ...
                    t.Commit();
                    input = ReadLine(); // keep console open
                }
            }
        }
    }
